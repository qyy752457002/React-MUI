      ...
      <Router>
        ...
        <Box bgcolor={'background.default'} color={'text.primary'}>
          ...
          <Routes>
            ...
            />
            <Route path="/home" element={<Box mt={5}><Homepage /></Box>} />  
            <Route path="/pages" element={<Box mt={5}><Pages /></Box>} />
            <Route path="/groups" element={<Box mt={5}><Groups /></Box>} />
            <Route path="/marketplace" element={<Box mt={5}><Marketplace /></Box>} />
            <Route path="/friends" element={<Box mt={5}><Friends /></Box>} />
            <Route path="/settings" element={<Box mt={5}><Settings /></Box>} />
            <Route path="/profile" element={<Box mt={5}><Profile /></Box>} />  
